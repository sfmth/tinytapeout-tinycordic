...
set ::env(DESIGN_NAME) scan_wrapper_019235602376235615
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_019235602376235615.v \
$::env(DESIGN_DIR)/scan_wrapper_019235602376235615.v"
